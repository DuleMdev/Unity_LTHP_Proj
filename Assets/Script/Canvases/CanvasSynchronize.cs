...
public class CanvasSynchronize : HHHScreen {
    ...
    override public IEnumerator InitCoroutine(Common.CallBack callBack = null)
    {
        Common.canvasMenuStripe.SetItem();
        ...
        // Ha befejeztük az inicializálást visszaszólunk
        if (callBack != null)
            callBack();
