...
public class CastleGameInventoryScreen : HHHScreen , IDataProvider
{
    public static CastleGameInventoryScreen instance;
        ...
        switch (splittedButtonName[0])
        {
            ...
            case "PlayGame":
                ...
                Common.CallBack gameFinish = () =>
                {
                    ...
                    Common.screenController.ChangeScreen(C.Screens.CastleGameInventoryScreen);
    ...
    public static void Load(Common.CallBack callBack)
    {
        CastleGameInventoryScreen.callBack = callBack;
