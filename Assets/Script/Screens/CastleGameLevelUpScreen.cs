...
public class CastleGameLevelUpScreen : HHHScreen
{
    ...
    {
        CastleGameLevelUpScreen.curriculumPathData = curriculumPathData;
        CastleGameLevelUpScreen.statusData = statusData;
        CastleGameLevelUpScreen.callBack = callBack;

        Common.screenController.ChangeScreen(C.Screens.CastleGameLevelUpScreen);
    }
}
