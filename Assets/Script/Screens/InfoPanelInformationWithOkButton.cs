...
public class InfoPanelInformationWithOkButton : InfoPanelBase
{
    ...
    {
        Common.infoPanelInformationWithOkButton = this;
    ...
    override protected void ShowComponents()
    {
        ...
        textOkButton.gameObject.SetActive(okButton); // Be / Ki kapcsoljuk az Ok gombot attól függően, hogy kell vagy nem kell
    }
}
