...
public class FadeEffectCanvas : MonoBehaviour {
    ...
    void SetPicture(int pictureIndex)
    {
        ...
        //image.sprite = sprite;     // A képet megjelenítjük
        image.color = Color.white; // A kép színét fehérre állítjuk (Lehet, hogy korábban a FadeColor-ral valamilyen másik színt állítottunk be, tehát azt semlegesíti ez az utasítás)
    }
