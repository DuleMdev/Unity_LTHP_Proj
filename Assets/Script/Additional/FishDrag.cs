...
public class FishDrag : DragItem {
    ...
    public void ChangeText(string newText) {
        ...
        else
        {
            ...
            RectTransform rectTransformTEXDraw = (RectTransform)texDraw.transform;
            float canvasMaxHeight = rectTransformTEXDraw.sizeDelta.y;
        ...
        textWidth = Mathf.Max(textWidth, textMinSize);
    ...
    void FixedUpdate()
    {
        ...
        if (swimEnabled && Common.configurationController.playAnimation)
        {
            /*
