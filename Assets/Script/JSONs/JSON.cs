                ...
                switch (aJSON[i])
                {
                    ...
                    case '\\':
                        ...
                        if (QuoteMode)
                        {
                            ...
                            switch (C)
                            {
                                case 't': Token.Append('\t'); /*Token += '\t';*/ break;
                                case 'r': Token.Append('\r'); /*Token += '\r';*/ break;
                                case 'n': Token.Append('\n'); /*Token += '\n';*/ break;
                                case 'b': Token.Append('\b'); /*Token += '\b';*/ break;
                                case 'f': Token.Append('\f'); /*Token += '\f';*/ break;
                                case 'u':
                                    {
